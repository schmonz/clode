#!/usr/bin/env python3
"""SPARC S2 campaign PHASE A run-2 driver — cmake bake remainder (persist).
...
guest-sparc-bake2.sh from the host file server on port 8180 and runs it:
...
setup = [
    ...
    ('ftp -o /tmp/bake2.sh http://10.0.2.2:8180/qemu/guest-sparc-bake2.sh', SILENCE_SETUP, 3),
]
...
run('sh /tmp/bake2.sh', SILENCE_BAKE)

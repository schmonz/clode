...
guest-sparc-debug.sh from the host file server on port 8180, and runs it.
...
LOGFILE = os.path.join(REPO, 'vendor', 'sparc-gates-console.log.run3')
...
setup = [
    ...
    ('ftp -o /tmp/gd.sh http://10.0.2.2:8180/qemu/guest-sparc-debug.sh', SILENCE_SETUP, 3),
]
...
run('sh /tmp/gd.sh', SILENCE_GATES)

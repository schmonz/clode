#!/usr/bin/env python3
"""SPARC S2 campaign PHASE A run-3 driver — cmake take three (persist).
...
guest-sparc-bake3.sh from the host file server on port 8180 and runs it:
...
setup = [
    ...
    ('ftp -o /tmp/bake3.sh http://10.0.2.2:8180/qemu/guest-sparc-bake3.sh', SILENCE_SETUP, 3),
]
...
run('sh /tmp/bake3.sh', SILENCE_BAKE)

...
3. Rebase it onto Bun-compatibility APIs
4. Rebase _that_ onto Node-compatibility APIs, mostly from [txiki.js](https://txikijs.org)
5. Compile it as [QuickJS-NG](https://quickjs-ng.github.io/quickjs/) bytecode
6. Write a native binary

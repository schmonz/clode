...
// scripts/merge-step.mjs under tjs (spawned by libexec/quaude-blobulate.js — Task 7 pulled the
// tjs-side call out of quaude-blobulate.js itself and into that protocol-only component).
//
